...
import com.sdu.composemusicplayer.domain.repository.MusicRepository as MusicRepositoryContract
import dagger.hilt.android.qualifiers.ApplicationContext
import kotlinx.coroutines.flow.Flow
import javax.inject.Inject
import kotlin.time.Duration.Companion.milliseconds

private const val MIN_TRACK_DURATION_SECONDS = 60
private const val MIN_TRACK_SIZE_KB = 100
...
class MusicRepositoryImpl
    ...
    constructor(
        ...
        private fun fetchMusicFromDevice(
            ...
            context.contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (shouldAddMusic(music, cursor, isTrackSmallerThan100KBSkipped, isTrackShorterThan60SecondsSkipped)) {
                        musicList.add(music)
                    }
                }
            }
        ...
        private fun createMusicEntityFromCursor(cursor: Cursor, context: Context, audioUriExternal: Uri): MusicEntity {
            ...
            return MusicEntity(
                audioId = audioID,
                title = title,
                artist = if (artist.equals("<unknown>", true)) {
        ...
        private fun shouldAddMusic(
            ...
            val durationGreaterThanMin = duration.milliseconds.inWholeSeconds > MIN_TRACK_DURATION_SECONDS
            val sizeGreaterThanMin = (size / BYTES_IN_KB) > MIN_TRACK_SIZE_KB

            return when {
                isTrackSmallerThan100KBSkipped && isTrackShorterThan60SecondsSkipped -> sizeGreaterThanMin && durationGreaterThanMin
                !isTrackSmallerThan100KBSkipped && isTrackShorterThan60SecondsSkipped -> durationGreaterThanMin
                isTrackSmallerThan100KBSkipped && !isTrackShorterThan60SecondsSkipped -> sizeGreaterThanMin
                else -> true
            }
        }
