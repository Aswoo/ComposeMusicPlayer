...
class FakePlaylistsRepositoryValidationTest {
    ...
    @Test
    fun `유효한_이름으로_플레이리스트_생성시_예외가_발생하지_않는다`() =
        runTest {
            // Given
    ...
    @Test
    fun `빈_이름으로_플레이리스트_생성시_예외가_발생하지_않는다`() =
        runTest {
            // Given
            val emptyName = ""
    ...
    @Test
    fun `유효한_ID로_플레이리스트_삭제시_예외가_발생하지_않는다`() =
        runTest {
            // Given
            val playlistId = 1
    ...
    @Test
    fun `존재하지_않는_ID로_플레이리스트_삭제시_예외가_발생하지_않는다`() =
        runTest {
            // Given
    ...
    @Test
    fun `유효한_파라미터로_플레이리스트_이름_변경시_예외가_발생하지_않는다`() =
        runTest {
            // Given
            val playlistId = 1
    ...
    @Test
    fun `존재하지_않는_ID로_플레이리스트_이름_변경시_예외가_발생하지_않는다`() =
        runTest {
            // Given
            val nonExistentId = 999
            val newName = "New Name"
    ...
    @Test
    fun `유효한_ID로_플레이리스트_가져오기시_예외가_발생하지_않는다`() =
        runTest {
            // Given
            val playlistId = 1
    ...
    @Test
    fun `존재하지_않는_ID로_플레이리스트_가져오기시_예외가_발생하지_않는다`() =
        runTest {
            // Given
            val nonExistentId = 999
