...
//    val instantTaskExecutorRule = InstantTaskExecutorRule()
    ...
    @Test
    fun `onEvent Play should call environment play and start service`() = runTest {
        // Arrange
        val testMusic = MusicEntity(
            audioId = 1L,
            title = "Test Music",
            artist = "Test Artist",
            duration = 180000L,
    ...
    @Test
    fun `onEvent PlayPause when not playing should resume and start service`() = runTest {
        // Arrange
    ...
    @Test
    fun `onEvent PlayPause when playing should pause and start service`() = runTest {
        // Arrange
    ...
    @Test
    fun `onEvent Next should call environment next`() = runTest {
        // Arrange
    ...
    @Test
    fun `onEvent SnapTo should call environment snapTo`() = runTest {
        // Arrange
